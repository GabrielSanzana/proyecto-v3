...
void Cargar_csv_de_stock(HashMap *mapaProducto, HashMap *mapaSemanal,
                         char *nombre_archivo, tipoDia *dia) {
...
void Exportar_mapa_semanal(char *nombre_archivo, Heap *monticuloMaximo, Heap *monticuloMinimo, List* listaDia) {
  ...
  FILE *archivo = fopen(nombre_archivo, "w");
  fprintf(archivo,
          "Producto,Precio de Compra,Precio de Venta,Stock,CantVendida,GastoDia,GananciaDia\n");
